...
@cocotb.test()
async def vga_timing_480p_full_test(dut):
    """Test the timing of VGA 480P"""

    H_ACTIVE = 640  # Horizontal Active
    H_FRONT = 16    # Horizontal Front Porch
    H_SYNC = 96     # Horizontal Sync
    H_BACK = 48     # Horizontal Back Porch
    H_LINE = H_ACTIVE + H_FRONT + H_SYNC + H_BACK

    V_ACTIVE = 480  # Vertical Active
    V_FRONT = 10    # Vertical Front Porch
    V_SYNC = 2      # Vertical Sync
    V_BACK = 33     # Vertical Back Porch
...
@cocotb.test()
async def vga_timing_480p_reset_test(dut):
